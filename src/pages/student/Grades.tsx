...
import type { GradesPageResponse, ExportGradesResponse } from '../../features/students/types/grades';
        ...
        <div className="flex min-h-screen bg-[var(--color-background)]">
            ...
            <div className="flex-1 ml-64">
                <div className="p-8">
                    ...
                    {/* Grades Table */}
                    <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-lg shadow-sm overflow-hidden">
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-[var(--color-background)] border-b border-[var(--color-border)]">
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-[var(--color-foreground)]">
                                            Course Code
                                        </th>
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-[var(--color-foreground)]">
                                            Course Name
                                        </th>
                                        <th className="px-6 py-4 text-center text-sm font-semibold text-[var(--color-foreground)]">
                                            Credits
                                        </th>
                                        <th className="px-6 py-4 text-center text-sm font-semibold text-[var(--color-foreground)]">
                                            Marks
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <div className="text-[var(--color-foreground)] font-medium">
                                                    {grade.totalMarks}/{grade.totalMaxMarks}
                                                </div>
                                                <div className="text-xs text-[var(--color-muted-foreground)]">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <span className="text-[var(--color-foreground)] font-semibold">
                                                    {grade.gradePoints != null ? grade.gradePoints.toFixed(1) : 'N/A'}
                                                </span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="text-[var(--color-foreground)]">
                                                    {grade.semester.displayName} {grade.semester.year}
                                                </span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="text-[var(--color-muted-foreground)]">
                                                    {grade.examDate ? new Date(grade.examDate).toLocaleDateString('en-US', {
                                                        year: 'numeric',
                                                        month: 'short',
                                                        day: 'numeric'
                                                    }) : 'N/A'}
                        ...
                        {data.myGrades.length === 0 && (
                            <div className="text-center py-12">
                                <Award className="w-12 h-12 text-[var(--color-muted-foreground)] mx-auto mb-3" />
                                <p className="text-[var(--color-muted-foreground)]">
